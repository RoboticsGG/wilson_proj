...
#include "msgs_positions/msg/detail/gnss_data__rosidl_typesupport_fastrtps_c.h"
...
#include "msgs_positions/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/string.h"  // date, time
#include "rosidl_runtime_c/string_functions.h"  // date, time

// forward declare type support functions


using _GnssData__ros_msg_type = msgs_positions__msg__GnssData;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_positions
size_t get_serialized_size_msgs_positions__msg__GnssData(
  const void * untyped_ros_message,
...
static uint32_t _GnssData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_positions__msg__GnssData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_positions
size_t max_serialized_size_msgs_positions__msg__GnssData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_positions__msg__GnssData;
    is_plain =
      (
...
static size_t _GnssData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_positions__msg__GnssData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_positions, msg, GnssData)() {
