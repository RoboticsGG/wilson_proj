...
#ifndef ROVER_CONTROL_PACKAGE__ACTION__DETAIL__CARCONTROL__FUNCTIONS_H_
#define ROVER_CONTROL_PACKAGE__ACTION__DETAIL__CARCONTROL__FUNCTIONS_H_
...
#include "rover_control_package/msg/rosidl_generator_c__visibility_control.h"

#include "rover_control_package/action/detail/carcontrol__struct.h"

/// Retrieve pointer to the hash of the description of this type.
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
rover_control_package__action__Carcontrol__get_individual_type_description_source(
  const rosidl_action_type_support_t * type_support);
 ...
 * calls
 * rover_control_package__action__Carcontrol_Goal__init().
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Goal__fini()
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_Goal__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * rover_control_package__action__Carcontrol_Goal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Goal__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_Result__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Result__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_Result__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_Result__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Result__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_Feedback__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Feedback__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_Feedback__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_Feedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_Feedback__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_SendGoal__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_SendGoal_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_SendGoal_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_SendGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_SendGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_SendGoal_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_SendGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_SendGoal_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_SendGoal_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_SendGoal_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_SendGoal_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_GetResult__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_GetResult_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_GetResult_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_GetResult_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_GetResult_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_GetResult_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_GetResult_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_GetResult_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_GetResult_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_GetResult_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_GetResult_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rover_control_package__action__Carcontrol_FeedbackMessage__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_FeedbackMessage__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
const rosidl_runtime_c__type_description__TypeSource *
rover_control_package__action__Carcontrol_FeedbackMessage__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * rover_control_package__action__Carcontrol_FeedbackMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rover_control_package
...
/**
 * It calls
 * rover_control_package__action__Carcontrol_FeedbackMessage__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROVER_CONTROL_PACKAGE__ACTION__DETAIL__CARCONTROL__FUNCTIONS_H_
