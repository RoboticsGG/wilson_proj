...
{
  new (message_memory) msgs_mainrocon::msg::MainRocon(_init);
}

void MainRocon_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs_mainrocon::msg::MainRocon *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MainRocon_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msgs_rovercon::msg::SubRocon>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_mainrocon::msg::MainRocon, mainrocon_msg),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MainRocon_message_members = {
  "msgs_mainrocon::msg",  // message namespace
  "MainRocon",  // message name
  1,  // number of fields
  sizeof(msgs_mainrocon::msg::MainRocon),
...
{
  return &::msgs_mainrocon::msg::rosidl_typesupport_introspection_cpp::MainRocon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_mainrocon, msg, MainRocon)() {
  return &::msgs_mainrocon::msg::rosidl_typesupport_introspection_cpp::MainRocon_message_type_support_handle;
}
