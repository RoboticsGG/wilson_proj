...
bool ifaces_position__msg__gnss_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ifaces_position.msg._gnss_data.GnssData", full_classname_dest, 39) == 0);
  }
  ifaces_position__msg__GnssData * ros_message = _ros_message;
  {  // date
...
PyObject * ifaces_position__msg__gnss_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ifaces_position.msg._gnss_data");
