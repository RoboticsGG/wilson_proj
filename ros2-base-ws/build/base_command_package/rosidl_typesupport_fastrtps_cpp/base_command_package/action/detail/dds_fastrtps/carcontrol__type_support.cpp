...
#include "base_command_package/action/detail/carcontrol__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_Goal & ros_message)
{
  // Member: direction
  cdr >> ros_message.direction;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_command_package::action::Carcontrol_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_base_command_package
const rosidl_message_type_support_t *
get_message_type_support_handle<base_command_package::action::Carcontrol_Goal>()
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_Goal)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result_msg
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_Result & ros_message)
{
  // Member: result_msg
  cdr >> ros_message.result_msg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_Result)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_Feedback & ros_message)
{
  // Member: time_remaining
  {
    cdr >> ros_message.time_remaining;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_Feedback)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_Feedback__handle;
}
...
// functions for base_command_package::action::Carcontrol_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  base_command_package::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  base_command_package::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    base_command_package::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_command_package::action::typesupport_fastrtps_cpp::max_serialized_size_Carcontrol_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_SendGoal_Request)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_SendGoal_Response)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal_Response__handle;
}
...
static rosidl_service_type_support_t _Carcontrol_SendGoal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_SendGoal)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_GetResult_Request)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for base_command_package::action::Carcontrol_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_command_package::action::typesupport_fastrtps_cpp::max_serialized_size_Carcontrol_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_GetResult_Response)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult_Response__handle;
}
...
static rosidl_service_type_support_t _Carcontrol_GetResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_GetResult)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_GetResult__handle;
}
...
// functions for base_command_package::action::Carcontrol_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_command_package
cdr_serialize(
  const base_command_package::action::Carcontrol_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_command_package::action::Carcontrol_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_command_package::action::typesupport_fastrtps_cpp::max_serialized_size_Carcontrol_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_command_package::action::Carcontrol_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_command_package::action::Carcontrol_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_command_package::action::Carcontrol_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_command_package, action, Carcontrol_FeedbackMessage)() {
  return &base_command_package::action::typesupport_fastrtps_cpp::_Carcontrol_FeedbackMessage__handle;
}
