...
static const _NavSatFix_type_support_symbol_names_t _NavSatFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_positions, msg, NavSatFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_positions, msg, NavSatFix)),
  }
};
...
{
  return &::msgs_positions::msg::rosidl_typesupport_cpp::NavSatFix_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs_positions, msg, NavSatFix)() {
  return get_message_type_support_handle<msgs_positions::msg::NavSatFix>();
}
