...
static const _MainRocon_type_support_symbol_names_t _MainRocon_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_mainrocon, msg, MainRocon)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_mainrocon, msg, MainRocon)),
  }
};
...
{
  return &::msgs_mainrocon::msg::rosidl_typesupport_cpp::MainRocon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs_mainrocon, msg, MainRocon)() {
  return get_message_type_support_handle<msgs_mainrocon::msg::MainRocon>();
}
