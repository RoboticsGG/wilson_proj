...
static const _GnssData_type_support_symbol_names_t _GnssData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_ifaces, msg, GnssData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msgs_ifaces, msg, GnssData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msgs_ifaces, msg, GnssData)() {
  return &::msgs_ifaces::msg::rosidl_typesupport_c::GnssData_message_type_support_handle;
}
