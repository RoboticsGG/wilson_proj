...
static const _NavSatFix_type_support_symbol_names_t _NavSatFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_positions, msg, NavSatFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msgs_positions, msg, NavSatFix)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msgs_positions, msg, NavSatFix)() {
  return &::msgs_positions::msg::rosidl_typesupport_c::NavSatFix_message_type_support_handle;
}
