...
#include "package_rover_control/action/detail/rovercontrol__rosidl_typesupport_fastrtps_c.h"
...
#include "package_rover_control/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Rovercontrol_Goal__ros_msg_type = package_rover_control__action__Rovercontrol_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Rovercontrol_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = package_rover_control__action__Rovercontrol_Goal;
    is_plain =
      (
...
static size_t _Rovercontrol_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Goal)() {
...
using _Rovercontrol_Result__ros_msg_type = package_rover_control__action__Rovercontrol_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_Result__ros_msg_type * ros_message = static_cast<const _Rovercontrol_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_Result;
    is_plain =
      (
...
static size_t _Rovercontrol_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Result)() {
...
using _Rovercontrol_Feedback__ros_msg_type = package_rover_control__action__Rovercontrol_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_Feedback__ros_msg_type * ros_message = static_cast<const _Rovercontrol_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_Feedback;
    is_plain =
      (
...
static size_t _Rovercontrol_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Feedback)() {
...
// already included above
// #include "package_rover_control/action/detail/rovercontrol__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_package_rover_control
...
using _Rovercontrol_SendGoal_Request__ros_msg_type = package_rover_control__action__Rovercontrol_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Rovercontrol_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_SendGoal_Request;
    is_plain =
      (
...
static size_t _Rovercontrol_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal_Request)() {
...
using _Rovercontrol_SendGoal_Response__ros_msg_type = package_rover_control__action__Rovercontrol_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Rovercontrol_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_SendGoal_Response;
    is_plain =
      (
...
static size_t _Rovercontrol_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal_Response)() {
...
using _Rovercontrol_SendGoal_Event__ros_msg_type = package_rover_control__action__Rovercontrol_SendGoal_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      package_rover_control__action__Rovercontrol_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      package_rover_control__action__Rovercontrol_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _Rovercontrol_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_SendGoal_Event;
    is_plain =
      (
...
static size_t _Rovercontrol_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_SendGoal_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal_Event)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_SendGoal)() {
...
using _Rovercontrol_GetResult_Request__ros_msg_type = package_rover_control__action__Rovercontrol_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Rovercontrol_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_GetResult_Request;
    is_plain =
      (
...
static size_t _Rovercontrol_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult_Request)() {
...
// already included above
// #include "package_rover_control/action/detail/rovercontrol__functions.h"  // result
...
using _Rovercontrol_GetResult_Response__ros_msg_type = package_rover_control__action__Rovercontrol_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Rovercontrol_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_GetResult_Response;
    is_plain =
      (
...
static size_t _Rovercontrol_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult_Response)() {
...
using _Rovercontrol_GetResult_Event__ros_msg_type = package_rover_control__action__Rovercontrol_GetResult_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult_Request
      )()->data);
    size_t size = ros_message->request.size;
    auto array_ptr = ros_message->request.data;
    if (size > 1) {
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult_Response
      )()->data);
    size_t size = ros_message->response.size;
    auto array_ptr = ros_message->response.data;
    if (size > 1) {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->request.data) {
      package_rover_control__action__Rovercontrol_GetResult_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->response.data) {
      package_rover_control__action__Rovercontrol_GetResult_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_GetResult_Event__ros_msg_type * ros_message = static_cast<const _Rovercontrol_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
static size_t _Rovercontrol_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_GetResult_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult_Event)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_GetResult)() {
...
// already included above
// #include "package_rover_control/action/detail/rovercontrol__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Rovercontrol_FeedbackMessage__ros_msg_type = package_rover_control__action__Rovercontrol_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t get_serialized_size_package_rover_control__action__Rovercontrol_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rovercontrol_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Rovercontrol_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_rover_control__action__Rovercontrol_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_rover_control
size_t max_serialized_size_package_rover_control__action__Rovercontrol_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_rover_control__action__Rovercontrol_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_rover_control__action__Rovercontrol_FeedbackMessage;
    is_plain =
      (
...
static size_t _Rovercontrol_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_rover_control__action__Rovercontrol_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_rover_control, action, Rovercontrol_FeedbackMessage)() {
