...
bool rovercon_msgs__msg__sub_rocon__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * rovercon_msgs__msg__sub_rocon__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rovercon_msgs.msg._sub_rocon");
