...
{
  new (message_memory) msgs_positions::msg::NavSatFix(_init);
}

void NavSatFix_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs_positions::msg::NavSatFix *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavSatFix_message_member_array[6] = {
  {
    "header",  // name
    ...
    offsetof(msgs_positions::msg::NavSatFix, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_positions::msg::NavSatFix, latitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_positions::msg::NavSatFix, longitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_positions::msg::NavSatFix, altitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(msgs_positions::msg::NavSatFix, position_covariance),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_positions::msg::NavSatFix, position_covariance_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NavSatFix_message_members = {
  "msgs_positions::msg",  // message namespace
  "NavSatFix",  // message name
  6,  // number of fields
  sizeof(msgs_positions::msg::NavSatFix),
...
get_message_type_support_handle<msgs_positions::msg::NavSatFix>()
{
  return &::msgs_positions::msg::rosidl_typesupport_introspection_cpp::NavSatFix_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_positions, msg, NavSatFix)() {
  return &::msgs_positions::msg::rosidl_typesupport_introspection_cpp::NavSatFix_message_type_support_handle;
}
