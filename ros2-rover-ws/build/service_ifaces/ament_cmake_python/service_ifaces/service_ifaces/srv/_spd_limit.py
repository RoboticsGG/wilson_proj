...
class Metaclass_SpdLimit(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from service_ifaces.srv import _spd_limit
...
class SpdLimit(metaclass=Metaclass_SpdLimit):
    from service_ifaces.srv._spd_limit import SpdLimit_Request as Request
    from service_ifaces.srv._spd_limit import SpdLimit_Response as Response
