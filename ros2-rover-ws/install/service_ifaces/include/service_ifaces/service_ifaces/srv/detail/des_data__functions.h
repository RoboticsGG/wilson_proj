...
#ifndef SERVICE_IFACES__SRV__DETAIL__DES_DATA__FUNCTIONS_H_
#define SERVICE_IFACES__SRV__DETAIL__DES_DATA__FUNCTIONS_H_
 ...
 * calls
 * service_ifaces__srv__DesData_Request__init().
...
/**
 * It calls
 * service_ifaces__srv__DesData_Request__fini()
 ...
 * service_ifaces__srv__DesData_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * service_ifaces__srv__DesData_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_ifaces__srv__DesData_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_ifaces
...
/**
 * It calls
 * service_ifaces__srv__DesData_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_service_ifaces
...
/**
 * It allocates the memory for the array and calls
 * service_ifaces__srv__DesData_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_ifaces
...
/**
 * It calls
 * service_ifaces__srv__DesData_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICE_IFACES__SRV__DETAIL__DES_DATA__FUNCTIONS_H_
