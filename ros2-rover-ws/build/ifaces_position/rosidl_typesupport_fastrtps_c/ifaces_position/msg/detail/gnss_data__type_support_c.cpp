...
#include "ifaces_position/msg/detail/gnss_data__rosidl_typesupport_fastrtps_c.h"
...
using _GnssData__ros_msg_type = ifaces_position__msg__GnssData;
...
size_t get_serialized_size_ifaces_position__msg__GnssData(
  const void * untyped_ros_message,
...
static uint32_t _GnssData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ifaces_position__msg__GnssData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ifaces_position
size_t max_serialized_size_ifaces_position__msg__GnssData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ifaces_position__msg__GnssData;
    is_plain =
      (
...
static size_t _GnssData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ifaces_position__msg__GnssData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ifaces_position, msg, GnssData)() {
