...
#include "msgs_ifaces/msg/detail/gnss_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_ifaces::msg::GnssData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_ifaces::msg::GnssData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_ifaces::msg::GnssData *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_msgs_ifaces
const rosidl_message_type_support_t *
get_message_type_support_handle<msgs_ifaces::msg::GnssData>()
{
  return &msgs_ifaces::msg::typesupport_fastrtps_cpp::_GnssData__handle;
}
