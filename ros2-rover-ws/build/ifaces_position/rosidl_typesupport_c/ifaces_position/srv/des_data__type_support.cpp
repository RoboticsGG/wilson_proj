...
static const _DesData_Request_type_support_symbol_names_t _DesData_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ifaces_position, srv, DesData_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ifaces_position, srv, DesData_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ifaces_position, srv, DesData_Request)() {
  return &::ifaces_position::srv::rosidl_typesupport_c::DesData_Request_message_type_support_handle;
}
...
static const _DesData_Response_type_support_symbol_names_t _DesData_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ifaces_position, srv, DesData_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ifaces_position, srv, DesData_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ifaces_position, srv, DesData_Response)() {
  return &::ifaces_position::srv::rosidl_typesupport_c::DesData_Response_message_type_support_handle;
}
...
static const _DesData_type_support_symbol_names_t _DesData_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ifaces_position, srv, DesData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ifaces_position, srv, DesData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ifaces_position, srv, DesData)() {
  return &::ifaces_position::srv::rosidl_typesupport_c::DesData_service_type_support_handle;
}
