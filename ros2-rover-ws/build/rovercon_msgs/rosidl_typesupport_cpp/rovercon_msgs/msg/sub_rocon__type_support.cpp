...
static const _SubRocon_type_support_symbol_names_t _SubRocon_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rovercon_msgs, msg, SubRocon)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rovercon_msgs, msg, SubRocon)),
  }
};
...
{
  return &::rovercon_msgs::msg::rosidl_typesupport_cpp::SubRocon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rovercon_msgs, msg, SubRocon)() {
  return get_message_type_support_handle<rovercon_msgs::msg::SubRocon>();
}
