...
#include "ifaces_position/srv/detail/des_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ifaces_position::srv::DesData_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ifaces_position::srv::DesData_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ifaces_position::srv::DesData_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ifaces_position
const rosidl_message_type_support_t *
get_message_type_support_handle<ifaces_position::srv::DesData_Request>()
{
  return &ifaces_position::srv::typesupport_fastrtps_cpp::_DesData_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ifaces_position::srv::DesData_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ifaces_position::srv::DesData_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ifaces_position::srv::DesData_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ifaces_position::srv::typesupport_fastrtps_cpp::_DesData_Response__handle;
}
...
{
  return &ifaces_position::srv::typesupport_fastrtps_cpp::_DesData__handle;
}
