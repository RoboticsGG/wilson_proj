...
#include "rover_control_package/action/detail/carcontrol__rosidl_typesupport_fastrtps_c.h"
...
#include "rover_control_package/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Carcontrol_Goal__ros_msg_type = rover_control_package__action__Carcontrol_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Carcontrol_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_control_package__action__Carcontrol_Goal;
    is_plain =
      (
...
static size_t _Carcontrol_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Goal)() {
...
using _Carcontrol_Result__ros_msg_type = rover_control_package__action__Carcontrol_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_Result__ros_msg_type * ros_message = static_cast<const _Carcontrol_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_Result;
    is_plain =
      (
...
static size_t _Carcontrol_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Result)() {
...
using _Carcontrol_Feedback__ros_msg_type = rover_control_package__action__Carcontrol_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_Feedback__ros_msg_type * ros_message = static_cast<const _Carcontrol_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_Feedback;
    is_plain =
      (
...
static size_t _Carcontrol_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Feedback)() {
...
// already included above
// #include "rover_control_package/action/detail/carcontrol__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rover_control_package
...
using _Carcontrol_SendGoal_Request__ros_msg_type = rover_control_package__action__Carcontrol_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Carcontrol_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_SendGoal_Request;
    is_plain =
      (
...
static size_t _Carcontrol_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal_Request)() {
...
using _Carcontrol_SendGoal_Response__ros_msg_type = rover_control_package__action__Carcontrol_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Carcontrol_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_SendGoal_Response;
    is_plain =
      (
...
static size_t _Carcontrol_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal_Response)() {
...
using _Carcontrol_SendGoal_Event__ros_msg_type = rover_control_package__action__Carcontrol_SendGoal_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Carcontrol_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _Carcontrol_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _Carcontrol_SendGoal_Event__ros_msg_type * ros_message = static_cast<_Carcontrol_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      rover_control_package__action__Carcontrol_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      rover_control_package__action__Carcontrol_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _Carcontrol_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _Carcontrol_SendGoal_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_SendGoal_Event;
    is_plain =
      (
...
static size_t _Carcontrol_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_SendGoal_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_Carcontrol_SendGoal_Event = {
  "rover_control_package::action",
...
static rosidl_message_type_support_t _Carcontrol_SendGoal_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Carcontrol_SendGoal_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal_Event)() {
  return &_Carcontrol_SendGoal_Event__type_support;
}
...
static rosidl_service_type_support_t Carcontrol_SendGoal__handle = {
  ...
  &_Carcontrol_SendGoal_Request__type_support,
  &_Carcontrol_SendGoal_Response__type_support,
  &_Carcontrol_SendGoal_Event__type_support,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_SendGoal)() {
...
using _Carcontrol_GetResult_Request__ros_msg_type = rover_control_package__action__Carcontrol_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Carcontrol_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_GetResult_Request;
    is_plain =
      (
...
static size_t _Carcontrol_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult_Request)() {
...
// already included above
// #include "rover_control_package/action/detail/carcontrol__functions.h"  // result
...
using _Carcontrol_GetResult_Response__ros_msg_type = rover_control_package__action__Carcontrol_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Carcontrol_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_GetResult_Response;
    is_plain =
      (
...
static size_t _Carcontrol_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult_Response)() {
...
using _Carcontrol_GetResult_Event__ros_msg_type = rover_control_package__action__Carcontrol_GetResult_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Carcontrol_GetResult_Event__ros_msg_type * ros_message = static_cast<const _Carcontrol_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult_Request
      )()->data);
    size_t size = ros_message->request.size;
    auto array_ptr = ros_message->request.data;
    if (size > 1) {
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult_Response
      )()->data);
    size_t size = ros_message->response.size;
    auto array_ptr = ros_message->response.data;
    if (size > 1) {
  ...
  void * untyped_ros_message)
{
  ...
  _Carcontrol_GetResult_Event__ros_msg_type * ros_message = static_cast<_Carcontrol_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->request.data) {
      rover_control_package__action__Carcontrol_GetResult_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->response.data) {
      rover_control_package__action__Carcontrol_GetResult_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_GetResult_Event__ros_msg_type * ros_message = static_cast<const _Carcontrol_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _Carcontrol_GetResult_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_GetResult_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
static size_t _Carcontrol_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_GetResult_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_Carcontrol_GetResult_Event = {
  "rover_control_package::action",
...
static rosidl_message_type_support_t _Carcontrol_GetResult_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Carcontrol_GetResult_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult_Event)() {
  return &_Carcontrol_GetResult_Event__type_support;
}
...
static rosidl_service_type_support_t Carcontrol_GetResult__handle = {
  ...
  get_service_typesupport_handle_function,
  &_Carcontrol_GetResult_Request__type_support,
  &_Carcontrol_GetResult_Response__type_support,
  &_Carcontrol_GetResult_Event__type_support,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    rover_control_package,
    action,
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_GetResult)() {
...
// already included above
// #include "rover_control_package/action/detail/carcontrol__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Carcontrol_FeedbackMessage__ros_msg_type = rover_control_package__action__Carcontrol_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t get_serialized_size_rover_control_package__action__Carcontrol_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Carcontrol_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Carcontrol_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_rover_control_package__action__Carcontrol_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rover_control_package__action__Carcontrol_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rover_control_package
size_t max_serialized_size_rover_control_package__action__Carcontrol_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rover_control_package__action__Carcontrol_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rover_control_package__action__Carcontrol_FeedbackMessage;
    is_plain =
      (
...
static size_t _Carcontrol_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rover_control_package__action__Carcontrol_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_control_package, action, Carcontrol_FeedbackMessage)() {
