...
#define NODE_MAIN_LOGGER_NAME "carcontrol_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcarcontrol_ros2_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<carcontrol_cpp::CarControlActionServer>";
