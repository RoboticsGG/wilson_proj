...
#include "msgs_positions/msg/detail/nav_sat_fix__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msgs_positions::msg::NavSatFix & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs_positions::msg::NavSatFix & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_positions::msg::NavSatFix;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_positions::msg::NavSatFix *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_positions::msg::NavSatFix *>(
    untyped_ros_message);
...
{
  return &msgs_positions::msg::typesupport_fastrtps_cpp::_NavSatFix__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_positions, msg, NavSatFix)() {
  return &msgs_positions::msg::typesupport_fastrtps_cpp::_NavSatFix__handle;
}
