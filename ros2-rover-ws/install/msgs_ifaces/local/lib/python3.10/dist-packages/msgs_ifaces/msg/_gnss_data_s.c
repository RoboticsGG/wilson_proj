...
bool msgs_ifaces__msg__gnss_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_ifaces.msg._gnss_data.GnssData", full_classname_dest, 35) == 0);
  }
  msgs_ifaces__msg__GnssData * ros_message = _ros_message;
  {  // date
...
PyObject * msgs_ifaces__msg__gnss_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_ifaces.msg._gnss_data");
