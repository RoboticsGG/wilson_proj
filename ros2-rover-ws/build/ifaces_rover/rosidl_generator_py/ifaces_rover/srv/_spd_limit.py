...
class Metaclass_SpdLimit_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ifaces_rover')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SpdLimit(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ifaces_rover.srv import _spd_limit
...
class SpdLimit(metaclass=Metaclass_SpdLimit):
    from ifaces_rover.srv._spd_limit import SpdLimit_Request as Request
    from ifaces_rover.srv._spd_limit import SpdLimit_Response as Response
