...
#define NODE_MAIN_LOGGER_NAME "node_motor_control"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotorcontrol.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<motorcontrol_cpp::MotorControlActionServer>";
