...
class Metaclass_DesData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ifaces_base.srv import _des_data
...
class DesData(metaclass=Metaclass_DesData):
    from ifaces_base.srv._des_data import DesData_Request as Request
    from ifaces_base.srv._des_data import DesData_Response as Response
