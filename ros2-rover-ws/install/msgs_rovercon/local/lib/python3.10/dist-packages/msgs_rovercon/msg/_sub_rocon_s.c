...
bool msgs_rovercon__msg__sub_rocon__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_rovercon.msg._sub_rocon.SubRocon", full_classname_dest, 37) == 0);
  }
  msgs_rovercon__msg__SubRocon * ros_message = _ros_message;
  {  // fdr_msg
...
{
  /* NOTE(esteve): Call constructor of SubRocon */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_rovercon.msg._sub_rocon");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SubRocon");
