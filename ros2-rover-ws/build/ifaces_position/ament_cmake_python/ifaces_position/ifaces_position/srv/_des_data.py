...
class DesData_Request(metaclass=Metaclass_DesData_Request):
    ...
    def des_lat(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'des_lat' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._des_lat = value
    ...
    def des_long(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'des_long' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
...
class Metaclass_DesData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ifaces_position.srv import _des_data
...
class DesData(metaclass=Metaclass_DesData):
    from ifaces_position.srv._des_data import DesData_Request as Request
    from ifaces_position.srv._des_data import DesData_Response as Response
