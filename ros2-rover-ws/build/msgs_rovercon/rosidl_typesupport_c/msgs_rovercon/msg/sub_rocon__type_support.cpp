...
static const _SubRocon_type_support_symbol_names_t _SubRocon_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_rovercon, msg, SubRocon)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msgs_rovercon, msg, SubRocon)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msgs_rovercon, msg, SubRocon)() {
  return &::msgs_rovercon::msg::rosidl_typesupport_c::SubRocon_message_type_support_handle;
}
