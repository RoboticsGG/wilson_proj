...
bool msgs_positions__msg__nav_sat_fix__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_positions.msg._nav_sat_fix.NavSatFix", full_classname_dest, 41) == 0);
  }
  msgs_positions__msg__NavSatFix * ros_message = _ros_message;
  {  // header
...
PyObject * msgs_positions__msg__nav_sat_fix__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_positions.msg._nav_sat_fix");
