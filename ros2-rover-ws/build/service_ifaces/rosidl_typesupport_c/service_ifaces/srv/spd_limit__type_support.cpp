...
static const _SpdLimit_Request_type_support_symbol_names_t _SpdLimit_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, SpdLimit_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_ifaces, srv, SpdLimit_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_ifaces, srv, SpdLimit_Request)() {
  return &::service_ifaces::srv::rosidl_typesupport_c::SpdLimit_Request_message_type_support_handle;
}
...
static const _SpdLimit_Response_type_support_symbol_names_t _SpdLimit_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, SpdLimit_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_ifaces, srv, SpdLimit_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_ifaces, srv, SpdLimit_Response)() {
  return &::service_ifaces::srv::rosidl_typesupport_c::SpdLimit_Response_message_type_support_handle;
}
...
static const _SpdLimit_type_support_symbol_names_t _SpdLimit_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, SpdLimit)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_ifaces, srv, SpdLimit)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, service_ifaces, srv, SpdLimit)() {
  return &::service_ifaces::srv::rosidl_typesupport_c::SpdLimit_service_type_support_handle;
}
