...
{
public:
  explicit Init_Rovercontrol_SendGoal_Event_response(::action_interfaces::action::Rovercontrol_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::action_interfaces::action::Rovercontrol_SendGoal_Event response(::action_interfaces::action::Rovercontrol_SendGoal_Event::_response_type arg)
  {
...
private:
  ::action_interfaces::action::Rovercontrol_SendGoal_Event msg_;
};

class Init_Rovercontrol_SendGoal_Event_request
{
public:
  explicit Init_Rovercontrol_SendGoal_Event_request(::action_interfaces::action::Rovercontrol_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Rovercontrol_SendGoal_Event_response request(::action_interfaces::action::Rovercontrol_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Rovercontrol_SendGoal_Event_request info(::action_interfaces::action::Rovercontrol_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::action_interfaces::action::Rovercontrol_SendGoal_Event>()
{
  return action_interfaces::action::builder::Init_Rovercontrol_SendGoal_Event_info();
}
...
{
public:
  explicit Init_Rovercontrol_GetResult_Event_response(::action_interfaces::action::Rovercontrol_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::action_interfaces::action::Rovercontrol_GetResult_Event response(::action_interfaces::action::Rovercontrol_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::action_interfaces::action::Rovercontrol_GetResult_Event msg_;
};

class Init_Rovercontrol_GetResult_Event_request
{
public:
  explicit Init_Rovercontrol_GetResult_Event_request(::action_interfaces::action::Rovercontrol_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Rovercontrol_GetResult_Event_response request(::action_interfaces::action::Rovercontrol_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Rovercontrol_GetResult_Event_request info(::action_interfaces::action::Rovercontrol_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::action_interfaces::action::Rovercontrol_GetResult_Event>()
{
  return action_interfaces::action::builder::Init_Rovercontrol_GetResult_Event_info();
}
