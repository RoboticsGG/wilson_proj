...
#include "msgs_positions/msg/detail/nav_sat_fix__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_msgs_positions
...
using _NavSatFix__ros_msg_type = msgs_positions__msg__NavSatFix;
...
size_t get_serialized_size_msgs_positions__msg__NavSatFix(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavSatFix__ros_msg_type * ros_message = static_cast<const _NavSatFix__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _NavSatFix__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_positions__msg__NavSatFix(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_positions
size_t max_serialized_size_msgs_positions__msg__NavSatFix(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_positions__msg__NavSatFix;
    is_plain =
      (
...
static size_t _NavSatFix__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_positions__msg__NavSatFix(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_positions, msg, NavSatFix)() {
