...
{
  new (message_memory) msgs_rovercon::msg::SubRocon(_init);
}

void SubRocon_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs_rovercon::msg::SubRocon *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SubRocon_message_member_array[4] = {
  {
    ...
    offsetof(msgs_rovercon::msg::SubRocon, fdr_msg),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_rovercon::msg::SubRocon, ro_ctrl_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_rovercon::msg::SubRocon, spd_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_rovercon::msg::SubRocon, bdr_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SubRocon_message_members = {
  "msgs_rovercon::msg",  // message namespace
  "SubRocon",  // message name
  4,  // number of fields
  sizeof(msgs_rovercon::msg::SubRocon),
...
{
  return &::msgs_rovercon::msg::rosidl_typesupport_introspection_cpp::SubRocon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_rovercon, msg, SubRocon)() {
  return &::msgs_rovercon::msg::rosidl_typesupport_introspection_cpp::SubRocon_message_type_support_handle;
}
