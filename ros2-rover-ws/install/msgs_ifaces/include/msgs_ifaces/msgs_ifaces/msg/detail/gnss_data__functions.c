...
msgs_ifaces__msg__GnssData__init(msgs_ifaces__msg__GnssData * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->date)) {
    msgs_ifaces__msg__GnssData__fini(msg);
    return false;
  }
  // time
...
msgs_ifaces__msg__GnssData__create()
{
  ...
  msgs_ifaces__msg__GnssData * msg = (msgs_ifaces__msg__GnssData *)allocator.allocate(sizeof(msgs_ifaces__msg__GnssData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msgs_ifaces__msg__GnssData));
  bool success = msgs_ifaces__msg__GnssData__init(msg);
  if (!success) {
...
msgs_ifaces__msg__GnssData__Sequence__init(msgs_ifaces__msg__GnssData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_ifaces__msg__GnssData * data = NULL;

  if (size) {
    data = (msgs_ifaces__msg__GnssData *)allocator.zero_allocate(size, sizeof(msgs_ifaces__msg__GnssData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msgs_ifaces__msg__GnssData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msgs_ifaces__msg__GnssData__fini(&data[i - 1]);
      }
...
msgs_ifaces__msg__GnssData__Sequence__fini(msgs_ifaces__msg__GnssData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msgs_ifaces__msg__GnssData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_ifaces__msg__GnssData__Sequence * array = (msgs_ifaces__msg__GnssData__Sequence *)allocator.allocate(sizeof(msgs_ifaces__msg__GnssData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msgs_ifaces__msg__GnssData__Sequence__init(array, size);
  if (!success) {
...
msgs_ifaces__msg__GnssData__Sequence__destroy(msgs_ifaces__msg__GnssData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msgs_ifaces__msg__GnssData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msgs_ifaces__msg__GnssData__Sequence__are_equal(const msgs_ifaces__msg__GnssData__Sequence * lhs, const msgs_ifaces__msg__GnssData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msgs_ifaces__msg__GnssData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msgs_ifaces__msg__GnssData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msgs_ifaces__msg__GnssData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msgs_ifaces__msg__GnssData * data =
      (msgs_ifaces__msg__GnssData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msgs_ifaces__msg__GnssData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msgs_ifaces__msg__GnssData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msgs_ifaces__msg__GnssData__copy(
