...
static const _GnssData_type_support_symbol_names_t _GnssData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ifaces_position, msg, GnssData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ifaces_position, msg, GnssData)),
  }
};
...
{
  return &::ifaces_position::msg::rosidl_typesupport_cpp::GnssData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ifaces_position, msg, GnssData)() {
  return get_message_type_support_handle<ifaces_position::msg::GnssData>();
}
