...
private:
    ...
    void timer_callback(){
        auto rovercon_msg_a = std_msgs::msg::String();
        rovercon_msg_a.data = rovercontrol_message_ + "," + speedlimit_message_ + "," + back_direction_message_;
        topic_rovercontrol_publisher_->publish(rovercon_msg_a);
