...
#include "service_ifaces/srv/detail/des_data__rosidl_typesupport_fastrtps_c.h"
...
using _DesData_Request__ros_msg_type = service_ifaces__srv__DesData_Request;
...
size_t get_serialized_size_service_ifaces__srv__DesData_Request(
  const void * untyped_ros_message,
...
static uint32_t _DesData_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_service_ifaces__srv__DesData_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_ifaces
size_t max_serialized_size_service_ifaces__srv__DesData_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = service_ifaces__srv__DesData_Request;
    is_plain =
      (
...
static size_t _DesData_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_service_ifaces__srv__DesData_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, DesData_Request)() {
...
using _DesData_Response__ros_msg_type = service_ifaces__srv__DesData_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_ifaces
size_t get_serialized_size_service_ifaces__srv__DesData_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DesData_Response__ros_msg_type * ros_message = static_cast<const _DesData_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_service_ifaces__srv__DesData_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_service_ifaces
size_t max_serialized_size_service_ifaces__srv__DesData_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = service_ifaces__srv__DesData_Response;
    is_plain =
      (
...
static size_t _DesData_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_service_ifaces__srv__DesData_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, DesData_Response)() {
...
// already included above
// #include "service_ifaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "service_ifaces/srv/des_data.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_ifaces, srv, DesData)() {
