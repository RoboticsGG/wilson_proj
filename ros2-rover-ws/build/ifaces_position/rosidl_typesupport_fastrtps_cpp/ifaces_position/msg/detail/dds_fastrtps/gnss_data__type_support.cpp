...
#include "ifaces_position/msg/detail/gnss_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ifaces_position::msg::GnssData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ifaces_position::msg::GnssData & ros_message)
{
  // Member: date
  cdr >> ros_message.date;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ifaces_position::msg::GnssData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ifaces_position::msg::GnssData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ifaces_position::msg::GnssData *>(
    untyped_ros_message);
...
get_message_type_support_handle<ifaces_position::msg::GnssData>()
{
  return &ifaces_position::msg::typesupport_fastrtps_cpp::_GnssData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ifaces_position, msg, GnssData)() {
  return &ifaces_position::msg::typesupport_fastrtps_cpp::_GnssData__handle;
}
